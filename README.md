...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/abicheck-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/abicheck-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-abicheck-green.svg)](https://anaconda.org/conda-forge/abicheck) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/abicheck.svg)](https://anaconda.org/conda-forge/abicheck) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/abicheck.svg)](https://anaconda.org/conda-forge/abicheck) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/abicheck.svg)](https://anaconda.org/conda-forge/abicheck) |

Installing abicheck
===================

Installing `abicheck` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search abicheck --channel conda-forge

# List packages depending on `abicheck`:
mamba repoquery whoneeds abicheck --channel conda-forge
...
Updating abicheck-feedstock
===========================

If you would like to improve the abicheck recipe or build a new
...
Note that all branches in the conda-forge/abicheck-feedstock are
